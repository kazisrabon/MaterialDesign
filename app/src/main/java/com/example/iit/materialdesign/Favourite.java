...
public class Favourite extends BaseActivity2 implements ObservableScrollViewCallbacks {
        ...
        result = new Drawer()
                ...
                .withOnDrawerListener(new Drawer.OnDrawerListener() {
                    ...
                    public void onDrawerOpened(View drawerView) {
                        Toast.makeText(Favourite.this, "onDrawerOpened", Toast.LENGTH_SHORT).show();
                        KeyboardUtil.hideKeyboard(Favourite.this);
                    }
